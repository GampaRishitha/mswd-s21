...
function BookAppointment() {
  ...
  const handleBookAppointment = () => {
    ...
    // Example API call
    const url = "http://localhost:8080/appointment/book";
    ...
    <div className='full-height'>
      <div className='appointment-content'>
        ...
        <table style={tableStyle}>
          ...
          <tr>
            <td>Parent name<input type='text' value={parentname} onChange={(e) => setparentname(e.target.value)} className='txtbox' /></td>
          </tr>
          <tr>
            <td>Parent phoneno<input type='text' value={parentphoneno} onChange={(e) => setparentphoneno(e.target.value)} className='txtbox' /></td>
          </tr>
          <tr>
            <td>Counsellor ID <input type='text' value={counsellorId} onChange={(e) => setCounsellorId(e.target.value)} className='txtbox' /></td>
          </tr>
          <tr>
            <td>Counsellor name<input type='text' value={counsellorname} onChange={(e) => setCounsellorname(e.target.value)} className='txtbox' /></td>
          </tr>
          <tr>
